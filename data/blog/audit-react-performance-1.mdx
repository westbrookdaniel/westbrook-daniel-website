---
title: 'Auditing React Performance Pt 1'
description: 'How to use the React DevTools Profiler'
date: 1653045254642
feature:
    {
        href: '/images/blog/audit-react-performance-1/feature.jpg',
        author:
            {
...
<Image
    ...
    height={403}
    border
    alt="Profiler Ranked Chart"
    src="/images/blog/audit-react-performance-1/profiler.png"
/>
...
<Image
    ...
    height={403}
    border
    alt="Profiler Flamegraph Chart"
    src="/images/blog/audit-react-performance-1/flamechart.png"
/>
...
trouble rendering, but sometimes your issue isn't to do with rendering. That's where
the next time's tool comes in - the performance panel. Stay tuned!
